...
- [6. 트랜잭션의 이해](docs/03.database-2.md#6-트랜잭션의-이해)
  + [6.1 트랜잭션 개념과 ACID 성질](docs/03.database-2.md#61-트랜잭션-개념과-acid-성질)
  + [6.2 커밋(Commit)과 롤백(Rollback)](docs/03.database-2.md##62-커밋commit과-롤백rollback)
  + [6.3 데이터 무결성 제약의 이해](docs/03.database-2.md#63-데이터-무결성-제약의-이해)
  - 💻 실습 (트랜잭션 A, 트랜젝션 B)
...
#### 오후(3시간)
- [7. JDBC (Java Database Connectivity)](docs/03.database-2.md#7-jdbc-java-database-connectivity)
  + [7.1 JDBC 동작 원리 및 주요 인터페이스](docs/03.database-2.md#71-jdbc-동작-원리-및-주요-인터페이스)
  + [7.2 JDBC 실습 예제](docs/03.database-2.md#72-jdbc-실습-예제)
