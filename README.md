...
- [2. SQL 기본](docs/03.database-1.md#2-sql-기본)
  - [2.2 DML (INSERT, SELECT, UPDATE, DELETE)](docs/03.database-1.md#22-dml-insert-select-update-delete)
    ...
    - 💻 실습 (데이터 삭제, Delete) [02_DML/delete.sql](workspace/03_database/query/02_DML/delete.sql)
...
- [5. 게시판 데이터베이스 스키마 작성](docs/03.database-1.md#5-게시판-데이터베이스-스키마-작성)
  + [5.3 조회 쿼리 연습](docs/03.database-1.md#53-조회-쿼리-연습)
    - 💻 실습 (게시판 조회 쿼리 연습) [board_exam.sql](workspace/03_database/query/board_exam.sql)
- [6. 트랜잭션의 이해](docs/04.database-2.md#6-트랜잭션의-이해)
  + [6.1 트랜잭션 개념과 ACID 성질](docs/04.database-2.md#61-트랜잭션-개념과-acid-성질)
  + [6.2 커밋(Commit)과 롤백(Rollback)](docs/04.database-2.md##62-커밋commit과-롤백rollback)
  + [6.3 데이터 무결성 제약의 이해](docs/04.database-2.md#63-데이터-무결성-제약의-이해)
  - 💻 실습 (트랜잭션 A, 트랜젝션 B)
    + [transaction-A.sql](workspace/03_database/query/04_TCL/transaction-A.sql)
    + [transaction-A.sql](workspace/03_database/query/04_TCL/transaction-B.sql)
...
- [11. 참조 타입(Array, 배열)](docs/06.javascript.md#11-참조-타입array-배열)
